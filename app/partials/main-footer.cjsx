    ...
    <footer className="main-footer">
      ...
      <section className="main-footer-social-media">
        ...
        <div className="social-media-links">
          ...
          <a href="https://twitter.com/WildCamGNP"target="_blank"><i className="fa fa-twitter fa-2x"></i></a>
          <a href="https://www.facebook.com/wildcamgorongosa?fref=ts" target="_blank"><i className="fa fa-facebook-official fa-2x"></i></a>
