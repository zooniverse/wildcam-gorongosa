...
module.exports = React.createClass
  ...
  render: ->
    <div className="secondary-page">
      ...
      <h2>What do I do if different individuals of the same species are engaging in different behaviors?</h2>
