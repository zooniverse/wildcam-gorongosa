...
module.exports = React.creatClass
  ...
  render: ->
    <div className="secondary-page">
      ...
      <h2>What if I identify something wrong? Will that mess up your data?</h2>
      ...
      <h2>What do I do if different individuals of the same species are doing different behaviors?</h2>
      ...
      <p>Some of the photos will be blurry or have animals way off in the distance. Our images are not high resolution because the website would be much too slow if we didn’t resize the images. However, some people still find that zooming in on the photo can be useful. You can do this in one of two ways:</p>
      ...
      <p>
        <ol>
          ...
          <li>
            ...
            <ul><li>Right click the image and click “save as” to save the image to your computer. You can then open the file and zoom in using an image editing software.</li></ul>
          </li>
        </ol>
      </p>

      <h2>Is there a way to see the images taken right before and right after an image?</h2>
      <p>All of our images are served to the website in a random order. Unfortunately, there is no good way to see the images before and after a given image.</p>

      <h2>How can I use WildCam Gorongosa in my classroom?</h2>
      <p>In the spring of 2016, we will launch an educator portal that will allow students to ask ecological questions, filter trail camera data, and download the data to analyze trends. Educators can use the portal to set up their classrooms, invite students, and manage projects and data for use in class. In the meantime, we will post activities on our <a href="http://www.wildcamgorongosa.org/education">Education</a> page using smaller sets of trail camera photos and data. You can also explore a variety of educational resources about Gorongosa National Park on <a href="http://www.biointeractive.org/gorongosa">BioInteractive.org</a>.</p>

      <h2>How can I ask a question about a topic that’s not in this FAQ?</h2>
      <p>The Talk forum is a great place to ask questions. Our scientists will be monitoring the discussion boards and answering as many questions as we can. There are also many seasoned Zooniverse volunteers who offer great advice on the forum.</p>
    </div>
