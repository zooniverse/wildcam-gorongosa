module.exports =
  ...
  description: '''
    There are 30 rodent species in Gorongosa including mice, rats, gerbils, squirrels, mole rats, dormice, and the porcupine. As the largest of the rodent species in Gorongosa, the porcupine has a separate field guide entry. The rest of the rodent species are small mammals with a long tail that ranges from smooth, in the case of mice and rats, to furry, in the case of gerbils and squirrels. All rodents have a pair of incisors on each side of the lower and upper jaw that grow continuously. They use these sharp incisors to gnaw food, excavate burrows and defend themselves.
  '''
  ...
  information: [{
    ...
    label: 'Weight'
    value: '0.003-23 kg, depending on species '
  }, {
    label: 'Lifespan'
