module.exports =
  scientificName: 'Aardvarikan'

  mainImage: 'http://placehold.it/400x200'
  information: [{
    label: 'Length'
    value: 'some value'
  }, {
  ...
  conservationStatus: 'low' # valid options: low, medium, high

  sections: [{
    title: 'Habitat'
    content: '''
      Yellow baboons are found in savanna grassland, steppe, and rainforest habitats.
    '''
  }, {
    title: 'Diet'
    content: '''
      Grasses, seeds, lichens, fruits, flowers, invertebrates, reptiles, birds, and other primates, such as vervet monkeys and bushbabies
    '''
  }, {
    title: 'Behavior'
    content: '''
