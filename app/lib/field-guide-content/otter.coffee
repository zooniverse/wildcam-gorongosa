module.exports =
  description: '''
    Two otter species live in Gorongosa: the spotted-necked otter (<i>Hydrictis maculicollis</i>) and the Cape clawless otter (<i>Aonyx capensis</i>). The spotted-necked otter is a medium-sized otter, varying in color but generally dark brown, with distinctive spots and streaks of paler color on the throat, neck, and in some cases the upper lip. More aquatic than other African otters, this species has fully webbed paws with sharp, well-developed claws. They have a broad head, blunt muzzle, short legs, and a long, flattened tail.
