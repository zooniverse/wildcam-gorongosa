module.exports =
  ...
  sections: [{
    ...
    title: 'Predators'
    content: 'Crows, ravens, ground hornbills, and birds of prey will all feed on eggs and young chicks.'
  }, {
    title: 'Behavior'
    content: '''
    ...
    content: '''
      <ol>
        <li>The secretarybird was supposedly given its common name because it resembles an old-fashioned secretary carrying quill pens tucked behind her ears.</li>
        <li>Some people refer to the secretarybird as “Africa’s marching eagle.” It earns this title because it prefers to move on the ground, and an individual can cover 30 km a day on foot.</li>
      </ol>
    '''
  },{
    title: 'Distribution'
