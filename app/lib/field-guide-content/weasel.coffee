module.exports =
  ...
  scientificName: ''
  mainImage: 'assets/fieldguide-content/mammals/weasel/weasel-feature.jpg'
  ...
  sections: [{
    ...
    title: 'Breeding'
    content: '''
      <p>A solitary species, zorillas are usually only seen together when mating. They have a gestation period of 36 days, and females generally give birth to a litter of one to three young. Zorillas are born in the spring and summer, and are able to kill mice by around nine weeks old.</p>
      <p>After a gestation period of 32 days, striped weasels give birth to a litter of one to three young. The young are weaned at 11 weeks and will reach sexual maturity between 1.5 and 3 years of age.</p>
    '''
  }, {
    title: 'Fun Facts'
    style: 'focus-box'
