module.exports = [
  {image: 'assets/tutorial-content/slide1.jpg'
  ...
  {image: 'assets/tutorial-content/slide2.gif'
  ...
  {image: 'assets/tutorial-content/slide3.gif'
  ...
  {image: 'assets/tutorial-content/slide4.gif'
  ...
  content: '''That’s it! You’re ready to start exploring Gorongosa! Make sure to sign in with your Zooniverse account (top right corner) so you can track your progress and collect images. Learn more on our About page or the WildCam Gorongosa blog. If you have any more questions or want to chat about the project, please join us on WildCam Gorongosa Talk. Thank you for your help!''',
  button: 'Finish'}
]
